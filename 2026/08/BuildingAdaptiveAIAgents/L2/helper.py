...
# ipywidgets isn't enabled in this sandbox, so tqdm falls back to text bars and
# warns once ("IProgress not found ..."). It's cosmetic; silence it here -- this
# module is imported first in Section 0, before anything pulls in tqdm.auto --
# so the setup cell stays clean.
...
from course_lab.m2_notebook import connect_stack           # noqa: E402, F401
from course_lab.coding_trace_synth import (                # noqa: E402, F401
    seed_into_memory, load_fixture,
)
from course_lab.skill_vectorstore import (                 # noqa: E402, F401
    index_skills_oraclevs, search_skills_oraclevs,
)
from course_lab.skill_render import render_skill_md        # noqa: E402, F401
from course_lab import paths                               # noqa: E402, F401
